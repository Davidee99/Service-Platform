...
public class DispacherController {
	...
	@GetMapping("/test")
	ResponseEntity<?> test() {
		String urlMailCustom = "http://localhost:5000/mailsender/test";
		ResponseEntity<?> response;
		try {
			response = restTemplate.exchange(urlMailCustom, HttpMethod.GET,null, String.class);
